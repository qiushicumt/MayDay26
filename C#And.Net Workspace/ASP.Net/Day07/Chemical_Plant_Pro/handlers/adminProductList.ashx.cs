...
namespace Chemical_Plant_Pro.handlers
{
    ...
    public class adminProductList : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            string html = null;
            DataTable dtProduct = SQLHelper.ExecuteDataTable("select T_Products.Name, T_ProductCategory.Name from T_Products left join T_ProductCategory on T_Products.CategoryId=T_ProductCategory.Id");
