    ...
    public class SchoolInitializer : DropCreateDatabaseIfModelChanges<SchoolContext>
    {
        protected override void Seed(SchoolContext context)
        {
            ...
            var enrollments = new List<Enrollment>
            {
                ...
                new Enrollment{ StudentID = 6, CourseID = 2042, Grade = Grade.E },
                new Enrollment{ StudentID = 7, CourseID = 3141, Grade = Grade.A },
                new Enrollment{ StudentID = 7, CourseID = 1045, Grade = Grade.F },
                new Enrollment{ StudentID = 8, CourseID = 3141, Grade = Grade.B },
                new Enrollment{ StudentID = 8, CourseID = 2021, Grade = Grade.C },
